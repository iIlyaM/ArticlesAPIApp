...
class ArticleControllerIntegrationTest {
    ...
    void createArticle_whenValidData_thenStatusBagRequest() throws Exception {
        ...
        requestDto.setTitle("test");
        requestDto.setText("test article." +
                "test articletest articletest articletest articletest articletest" +
                " articletest articletest articletest articletest articletest" +
                " articletest articletest articletest articletest articletest " +
                "articletest articletest articletest articletest articletest" +
                " articletest articletest articletest articletest articletest" +
                " articletest articletest articletest articletest articletest" +
                " articletest articletest articletest articletest articletest" +
                " articletest articletest articletest articletest articletest article");
